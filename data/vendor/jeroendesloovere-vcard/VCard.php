...
class VCard
{
	...
	//Organization//
	public function addOrganization($company, $organization = '')
    {
        $this->setProperty(
            'organization',
     ...
     * @return $this
     */
    public function addPhoneNumber($number, $type = 'Work')
    {
        $this->setProperty(
            'phoneNumber',
            'TEL' . (($type != '') ? ';' . $type : ''),
	...
	public function addwhatsappnumber($number, $type = 'WhatsApp')
    {
        $this->setProperty(
            'WhatsappNumber',
            'TEL' . (($type != '') ? ';' . $type : ''),
	...
	//Add Linkedin URL
	public function addLinkedinURL($url, $type = '')
    {
        $this->setProperty(
            'url',
            'URL' . (($type != '') ? ';' . $type : ''),
		...
		//Add Instagram URL
	public function addInstaURL($url, $type = '')
    {
        $this->setProperty(
            'url',
            'URL' . (($type != '') ? ';' . $type : ''),
	...
	//Add Facebook URL
	public function addFacebookURL($url, $type = '')
    {
        $this->setProperty(
            'url',
            'URL' . (($type != '') ? ';' . $type : ''),
	...
	//Add Twitter URL
	public function addTwitterURL($url, $type = '')
    {
        $this->setProperty(
            'url',
            'URL' . (($type != '') ? ';' . $type : ''),
